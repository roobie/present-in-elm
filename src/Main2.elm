...
type alias Model =
    ...
    , slidesDone : List ( Slide, List SlideStep )
    ...
    case msg of
        ...
        NextSlide ->
            ( { model
                ...
                , slidesDone = ( model.slide, model.stepsSoFar ) :: model.slidesDone
              }
            , Cmd.none
            )

        PrevSlide ->
            case maybePrevSlide of
                Just ( prevSlide, prevSlideSteps ) ->
                    ( { model
                        | stepsSoFar = prevSlideSteps
                        , stepsLeft = []
                        , slide = prevSlide
                        , slides = ( model.slide, model.stepsLeft ) :: model.slides
                        , slidesDone = List.drop 1 model.slidesDone
                      }
                    , Cmd.none
                    )
